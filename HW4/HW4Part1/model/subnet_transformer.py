...
class Vision_TransformerSubnet(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        super(Vision_TransformerSubnet, self).__init__()
        ...
        # classifier head
        self.head = LinearSuper(embed_dim[0], num_classes) if num_classes > 0 else nn.Identity()
